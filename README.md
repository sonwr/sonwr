...
- 🌐 **[mcp-domain-radar](https://github.com/sonwr/mcp-domain-radar)** — MCP server for real-time domain availability checking during AI-powered brand naming. 30+ TLDs, no API keys needed. *(personal)*
